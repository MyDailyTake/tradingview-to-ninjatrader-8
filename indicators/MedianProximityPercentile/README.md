# Median Proximity Percentile [AlgoAlpha] — NinjaTrader 8

A faithful, **non-repainting** NinjaScript conversion of the TradingView Pine indicator by **AlgoAlpha**.

| | |
|---|---|
| **Full write-up** | [mydailytake.com](https://mydailytake.com/tradingview-median-proximity-percentile-algoalpha-conversion-to-ninjatrader-8/) |
| **Original Pine script** | [by AlgoAlpha](https://www.tradingview.com/script/YEu4VVBj) |
| **License** | **MPL-2.0** — inherited from the original. See [LICENSE](LICENSE). |
| **Platform** | NinjaTrader 8 |

## What it does

In the ever-evolving landscape of financial markets, traders are constantly on the lookout for tools that can provide them with an edge. The Median Proximity Percentile indicator, developed by AlgoAlpha, is one such tool that has gained attention for its innovative approach to market analysis.

[Read the full write-up →](https://mydailytake.com/tradingview-median-proximity-percentile-algoalpha-conversion-to-ninjatrader-8/)
...
|---|---|---|
| Parameters | **Parameters** | Set the lookback length for calculating the median. |
